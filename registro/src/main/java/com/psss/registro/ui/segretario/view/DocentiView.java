...
//        this.classeService = classeService;
        ...
        DocenteGrid docenteGrid = new DocenteGrid(this.docenteService, this.materiaService);
        DocenteEditor docenteEditor = new DocenteEditor(this.docenteService, this.materiaService);
